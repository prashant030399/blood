...
<div class='container'>
      <h4 style="padding-top:10px; font-size:25px; ">  <center><u>Manage Donation Request</center></u> </h4> <br>
...
<td>$row[status]</td>   
     ...
     <td>  <a href='approverequestadmin.php?id=$row[id]'>  <input type='submit' value='Approve' class='btne' ></a>
     <a href='rejectrequestadmin.php?id=$row[id]'>  <input type='submit' value='Reject' class='btnd' ></a>      </td>
