...
<div class='container'>
      <h4 style="padding-top:10px; font-size:25px; ">  <center><u>List of all Donors</center></u> </h4> <br>
...
<td>$row[email]</td>
<td>$row[contactno]</td>
<td>     <a href='editdonornew.php?id=$row[email]'>  <input type='submit' value='Edit' class='btne' ></a>
<a href='deletedonornew.php?id=$row[email]'>  <input type='submit' value='Delete' class='btnd' ></a>      </td>
</tr>
