...
<body>
<form action="registerpatient1.php">
...
<div class='container'>
    ...
    <p style="font-size:15px; margin-left:10%;   " > PatientID:</p>
    <p style="font-size:15px; margin-left:10%; " > <input type='text' name='t0' id='t0' placeholder='Enter registerID'  style="width:80%; height:25px; border-radius:5px;  " >
