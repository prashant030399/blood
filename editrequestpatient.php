...
<p style="text-align:center; padding-top:10px; font-size:20px;" > Edit Patient Request Page </p>
    <hr class='hrr'><br>
...
<form action="editrequestpatient1.php">
    <?php
    $i=$_GET['id'];
    $con=mysqli_connect('localhost','root','seedit','bloodmgmtproject');
 $q=" select * from requestpatient where id=$i  ";
...
<p class='name'> RequestID:</p>
<p class='name'><input value='$row[id]' type='text' name='i' class='inputbox'  ></p>

<p class='name'> Bloodgroup:</p>
<p class='name'><input value='$row[bloodgroups]' type='text' name='b' class='inputbox'    ></p>

<p class='name'> Units:</p>
<p class='name'><input value='$row[units]' type='text' name='u' class='inputbox'   ></p>

<p class='name'> Reasons:</p>
<p class='name'> <input value='$row[reasons]' type='text' name='d' class='inputbox'   ></p>
