...
<div class='container1'>
    <div class='box'>
        <form action="donatedonor1.php">

    <center> <p style="font-size:25px; padding-top:5px; ">Blood Donation Form</p></center>
...
<p  style=" padding-top:10px; padding-left:5px; ">Diseases (if any) </p>
<input type='text' name='d' placeholder=" Mention disease if any (Optional)" style="width:94% ; height:70px; margin-left:5px; margin-top:5px; border-radius:5px; ">
<br>
<input type='submit' value="Submit" style="width:20%; background-color:red; height:30px; color:white; border-radius:5px; margin-left:5px; margin-top:5px; ">
...
<div class='container2'>
 <img src='check.jpg' style=" width:80%; height:250px; margin-left:10%;  margin-top:65px; border-radius:10px; ">
