...
<div class='container'>
    ...
    <p style="text-align:center; padding-top:20px; font-size:30px;" > Donor login Page </p> 
    <hr class='hrr'><br>
...
<span style="font-size:15px;">don't have an account? <span style="color:blue;"><a href="registerdonor.php"><u>Register Here</u></a></span></span>
...
$q="select * from donorlogin2 where email='$e' and password='$p'  ";
...
if($row=mysqli_fetch_array($res))
{
    ...
    $_SESSION['donor']=$a;
    $_SESSION['emaildonor']=$ed;
    $_SESSION['contactnodonor']=$cd;
    ...
    echo"<script>window.location='dashboarddonor.php?id=$row[email]'</script>";
