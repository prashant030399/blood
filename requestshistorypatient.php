...
<h4 style="padding-top:10px; font-size:25px; ">  <center><u>Your Requests</center></u> </h4> <br>
...
<tr class='tr1'><td>S.No</td><td>Request ID</td><td>Units (in ml)</td><td>Status</td><td>Action</td></tr>
 ";
...
<a href='editrequestpatient.php?id=$row[id]'>  <input type='submit' value='Edit' class='btne' ></a>
        <a href='deleterequestpatient.php?id=$row[id]'>  <input type='submit' value='Delete' class='btnd' ></a>  
